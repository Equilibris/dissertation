...
This is done through progressive approximation (@progapprox).
...
@progapprox and @cfix both are implemented in Avigard et al @avigad_et_al.
...
We have two encodings of the $M$ type.
...
The baseline implementation of this should be straight-forward.
