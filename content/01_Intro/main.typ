...
- We want an interface that lets us unfold and reason about definition just how we would any other function.
...
and simply use this as the semantics.
...
- We want to be able to encode effects in the language in addition to just non-termination.
